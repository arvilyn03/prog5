...
# Load dead sound
dead_sound = pygame.mixer.Sound(os.path.join("Assets/sounds", "dead_sound.wav"))

# Load background music
pygame.mixer.music.load(os.path.join("Assets/sounds", "bgmusic.mp3"))

# Load jumping sound
jump_sound = pygame.mixer.Sound(os.path.join("Assets/sounds", "whoosh.mp3"))
...
# Add this function to display the dead character
def dead():
    pygame.mixer.music.stop()  # Stop background music
    dead_image = pygame.image.load(os.path.join("Assets/character", "dead.jpg"))
    dead_rect = dead_image.get_rect(center=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2))
    ...
    pygame.time.delay(3000)  # Display the dead character for 3 seconds
    return
...
def main():
    ...
    # Set the volume to 50% (adjust as needed)
    pygame.mixer.music.set_volume(0.5)

    pygame.mixer.music.play(0)  # Start playing background music
    run = True
    ...
    # Stop the mixer when the program exits
    pygame.mixer.quit()
...
# Make sure to call the main function at the end
menu(death_count=0)
